...
/**
 * Creates a named Struct class with typed fields, supporting fixed and variable-length binary encoding.
 *
 * @param {string} name - The name of the generated class.
 * @param {Object.<string, DataType>} defs - An object mapping field names to their data type definitions.
 *   Each data type must expose `length`, `defaultValue`, `fromBuffer`, and `toBuffer`.
 * @param {Object} [opts] - Optional configuration.
 * @param {'default'|'skip'} [opts.encodeMissingFieldsBehavior='default'] - Controls how fields with
 *   `undefined` values are handled during encoding. `'default'` fills them with the type's default value;
 *   `'skip'` omits them entirely from the encoded output.
